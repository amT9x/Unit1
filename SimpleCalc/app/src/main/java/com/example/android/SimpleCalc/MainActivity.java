...
//        btnAdd.setOnClickListener(this);
    ...
    private void compute(Calculator.Operator operator) {
        ...
        try {
            ...
            if(operandTwo.isNaN() || operandOne.isNaN()){
                Toast.makeText(this, "Chua nhap du", Toast.LENGTH_SHORT).show();

            }
            Log.d(TAG, "compute: " + operandOne + " " + operandTwo + " " + Double.NaN);
        ...
        if(result.equals("NaN")){
            mResultTextView.setText("Chua nhap du");
        }else {
    ...
    private Double getOperand(EditText operandEditText) {
        ...
        return operandText.isEmpty() ? Double.NaN : Double.valueOf(operandText);
